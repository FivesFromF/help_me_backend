...
// Consumes EVERY event from both the system and emergency buses (the audit rules
// match all sources) and persists it to the audit-logs DynamoDB table.
//   hash_key  actor_id   — who performed the action
//   range_key timestamp  — "<iso>#<eventId>" to stay chronological + unique
